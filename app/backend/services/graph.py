...
async def run_graph_async(graph, portfolio, tickers, start_date, end_date, model_name, model_provider, request=None, force_refresh: bool = False):
    ...
    result = await loop.run_in_executor(None, lambda: run_graph(graph, portfolio, tickers, start_date, end_date, model_name, model_provider, request, force_refresh))  # Use default executor
    return result
