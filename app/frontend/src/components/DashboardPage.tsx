            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">${(stats.portfolioValue / 1000000).toFixed(1)}M</p>
                </div>
                ...
                {recentAnalyses.map((analysis, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div className="flex items-center gap-3">
                      <div className="font-semibold text-gray-900">{analysis.ticker}</div>
                      <Badge 
                        variant={analysis.signal === 'STRONG BUY' ? 'secondary' : 'outline'}
                        className={analysis.signal === 'STRONG BUY' ? 'bg-green-600 text-white' : 'bg-blue-600 text-white'}
                      >
                        {analysis.signal}
                      </Badge>
                    </div>
                    <div className="text-right">
                      <div className="text-green-600 font-medium">{analysis.change}</div>
            ...
            <Card className="h-full hover:shadow-lg transition-all duration-300 border-l-4 border-l-green-500">
              <CardContent className="p-6">
                <div className="space-y-3">
                  ...
                  <p className="text-gray-600 text-sm">Discover trending stocks with buy signals from our AI analysts</p>
            ...
            <Card className="h-full hover:shadow-lg transition-all duration-300 border-l-4 border-l-blue-500">
              <CardContent className="p-6">
                <div className="space-y-3">
                  ...
                  <p className="text-gray-600 text-sm">Track volatile stocks and monitor your watchlist in real-time</p>
            ...
            <Card className="h-full hover:shadow-lg transition-all duration-300 border-l-4 border-l-purple-500">
              <CardContent className="p-6">
                <div className="space-y-3">
                  ...
                  <h3 className="font-semibold text-lg">🏷️ Value Picks</h3>
                  <p className="text-gray-600 text-sm">Long-term recommendations from value-focused AI investors</p>
            ...
            <Card className="h-full hover:shadow-lg transition-all duration-300 border-l-4 border-l-orange-500">
              <CardContent className="p-6">
                <div className="space-y-3">
                  ...
                  <h3 className="font-semibold text-lg">🧠 AI Masters</h3>
                  <p className="text-gray-600 text-sm">Meet our 17 legendary AI investment advisors and their strategies</p>
